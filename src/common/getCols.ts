...
const sportSpecificCols = bySport<{
	...
	basketball: {
		...
		"stat:ortgOn": {
			desc: "Team Offensive Rating While On Court (points per 100 possessions)",
			sortSequence: ["desc", "asc"],
			sortType: "number",
			title: "Tm ORtg On",
		},
		"stat:ortgOff": {
			desc: "Team Offensive Rating While Off Court (points per 100 possessions)",
			sortSequence: ["desc", "asc"],
			sortType: "number",
			title: "Tm ORtg Off",
		},
		"stat:drtgOn": {
			desc: "Team Defensive Rating While On Court (points allowed per 100 possessions)",
			sortSequence: ["asc", "desc"],
			sortType: "number",
			title: "Tm DRtg On",
		},
		"stat:drtgOff": {
			desc: "Team Defensive Rating While Off Court (points allowed per 100 possessions)",
			sortSequence: ["asc", "desc"],
			sortType: "number",
			title: "Tm DRtg Off",
		},
		"stat:netrtgOn": {
			desc: "Team Net Rating While On Court (point differential per 100 possessions)",
			sortSequence: ["desc", "asc"],
			sortType: "number",
			title: "Tm Net On",
		},
		"stat:netrtgOff": {
			desc: "Team Net Rating While Off Court (point differential per 100 possessions)",
			sortSequence: ["desc", "asc"],
			sortType: "number",
			title: "Tm Net Off",
		},
		"stat:tovpOn": {
			desc: "Team Turnover Percentage While On Court",
			sortSequence: ["asc", "desc"],
			sortType: "number",
			title: "Tm TOV% On",
		},
		"stat:tovpOff": {
			desc: "Team Turnover Percentage While Off Court",
			sortSequence: ["asc", "desc"],
			sortType: "number",
			title: "Tm TOV% Off",
		},
