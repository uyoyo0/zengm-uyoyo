		...
		children: [
			...(isSport("soccer")
				? [
						{
							type: "link" as const,
							active: (pageID: string | undefined) =>
								pageID === "soccerTransferMarket",
							league: true as const,
							commandPalette: true as const,
							path: ["transfer_market"],
							text: "Transfers",
						},
						{
							type: "link" as const,
							active: (pageID: string | undefined) =>
								pageID === "soccerTactics",
							league: true as const,
							commandPalette: true as const,
							path: ["tactics"],
							text: "Tactics",
			...
			...(!isSport("soccer")
				? [
						{
							type: "link" as const,
							active: (pageID: string | undefined) => pageID === "playoffs",
							league: true as const,
							commandPalette: true as const,
							path: ["playoffs"],
							text: "Playoffs",
