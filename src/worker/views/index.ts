...
export { default as frivolitiesCoaches } from "./frivolitiesCoaches.ts";
export { default as frivolitiesLineups } from "./frivolitiesLineups.ts";
...
export { default as soccerCompetitions } from "./soccerCompetitions.ts";
export { default as soccerTransferMarket } from "./soccerTransferMarket.ts";
export { default as soccerTactics } from "./soccerTactics.ts";
